...
def get_current_version():
    with open("src/polystore/__init__.py", "r") as f:
        for line in f:
...
def get_pypi_version():
    try:
        response = requests.get("https://pypi.org/pypi/polystore/json")
...
def main():
    ...
    try:
        ...
        print("Monitor progress at: https://github.com/OpenHCSDev/PolyStore/actions")
